...
public class B314commentsSemanticsTest {
    ...
    @Test
    public void test1_var_not_exist() throws Exception{
        CompilerTestHelper.launchCompilation("/semantics/testFunct/test1_var_not_exist.b314", testFolder.newFile(),true,"test1_var_not_exist");
    }
